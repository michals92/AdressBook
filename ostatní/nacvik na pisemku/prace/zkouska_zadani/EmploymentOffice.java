...
public class EmploymentOffice
{
   ...
   private static final String nameFile = "DB.txt";
   ...
   public void loadData(InputStream is) throws EmploymentOfficeException, IOException {
    if (is == null) {
    ...
    try{
        ...
        while((line = reader.readLine()) != null) {
            ...
            if (split[0].equals("job")){
                ...
                throw new EmploymentOfficeException("Illegal format");
            }
        }
